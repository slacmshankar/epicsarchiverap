 ...
 * <ol>
 * <li>The <code>pb</code> prefix initializes {@link edu.stanford.slac.archiverappliance.PlainPB.PlainPBStoragePlugin PlainStoragePlugin}.</li>
...
public class StoragePluginURLParser {
    ...
    private static PlainPBStoragePlugin parsePlainStoragePlugin(String srcURIStr, ConfigService configService)
            throws IOException {
